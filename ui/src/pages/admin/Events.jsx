      ...
      <div className="space-y-6">
        ...
        >
          <div>
            ...
            <p className="text-gray-400">Manage cultural events and celebrations</p>
          </div>
          <motion.button
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="flex items-center gap-2 bg-amber-600 hover:bg-amber-700 text-white px-4 py-3 rounded-lg font-semibold transition-colors"
          >
            <Plus size={20} />
            Add Event
          </motion.button>
          ...
          >
            {filteredEvents.map(event => (
              <motion.div
                ...
                whileHover={{ y: -5 }}
                className="bg-gray-800 rounded-lg border border-gray-700 p-6 hover:border-blue-600/50 transition-colors"
              >
                ...
                <div className="mb-4 pb-4 border-t border-gray-700">
                  <span className="inline-block text-xs font-semibold px-3 py-1 rounded bg-blue-900/30 text-blue-300">
                    Published
                  </span>
                </div>
